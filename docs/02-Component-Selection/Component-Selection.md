...
| Solution | Pros  | Cons |
| ----- | ----- | ----- |
| **![](image1.png)** Option 1<br> 33JPF-15380-50 12V DC Motor <br> $20/each <br> [Link to Product](https://www.futureelectronics.com/p/semiconductors--analog--sensors--time-off-flight-sensors/vl53l1cxv0fy-1-stmicroelectronics-3100441) | High torque for its size. <br> <br> controlled speed output.<br> <br>Simple 2-wire DC operation.<br> <br>I already have this.<br> <br>Metal gearbox. | Noise.<br> <br>Limited lifespan under heavy load.<br><br> low precision.|
